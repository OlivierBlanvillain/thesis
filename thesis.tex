...
\cleardoublepage
\chapter*{Abstract}
\markboth{Abstract}{Abstract}% max 3499 characters
...
We demonstrate the practicality of our newly introduced techniques throughout the dissertation, by the means of case studies and examples.
Our performance evaluation shows that our new proposals also outperform the status quo in terms of binary sizes and compilation times.
