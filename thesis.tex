...
They \emph{do} provide a simple, first-class solution to type-level programming which is both easy to use and fast to compile.
Beyond the scope of Scala, it will interesting to see if our design can inspire other languages interested in moving their type system towards dependent types.
