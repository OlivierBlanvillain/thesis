...
All else being equal, an implicit definition that takes some implicit parameters is considered to be less specific than an implicit definition that takes none~\citep[Changes in Implicit Resolution]{odersky2013scala}.
...
\subsection*{Attribution}
% TODO: Cite the symposium submission
...
We plan to submit this work to the upcoming Scala Symposium.
...
For the generalized singleton benchmarks, we used our prototype, which lives in a branch of the dotty-staging repository\footnote{\texttt{git clone git@github.com:dotty-staging/dotty.git --branch add-transparent-7}}.
...
% TODO you could write a bit more. Maybe move some of the text of the conclusions of individual chapters there?
