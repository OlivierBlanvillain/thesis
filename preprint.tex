...
% \measurements{Comparing the compilation times of two implementations of list concatenation and join, log.\ scale.}
% TODO OLIVIER
...
% \Cref{measurements} shows that, in both benchmarks, the dependently-typed implementation compiles faster than the version with implicits, and compilation time scales better with the size of the input.
% TODO OLIVIER
...
In~\citep{stone2000deciding}, Stone and Harper describe a dependently-typed calculus with singleton kinds and subkinding.
