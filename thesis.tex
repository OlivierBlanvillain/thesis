...
The binary sizes for singleton- and match-type-based implementations are stable with respect to benchmark input size, which is expected given that our benchmarks consist of type-level-only operations.
The implicit-based implementation come with an
