...
Parametrized implicit definitions can lead to recursive implicit resolution. This is where the (type-level) fun begins!
For instance, when the compiler is looking for an implicit of type |Ordering[Ordering[List[T]]]|, it will use |listOrdering| twice to synthesize an implicit of that type.
...
%\footnote{In this example, |1| and |2| are used both as term and type literals.}.
