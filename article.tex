...
Detailed pen-and-paper proofs is available in the appendix of this thesis.
A Coq mechanization of our proofs is available online\footnote{\url{https://zenodo.org/record/5568850}}.
Our mechanization uses the locally nameless representation by \citet{aydemir2008engineering} to model variable bindings, and a simplified representation of match types with exactly one case per match.
