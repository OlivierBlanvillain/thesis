...
\begin{diff}
An important conceptual difference between both approaches is ours only focuses on type checking (we rely on Java's regular expressions at run-time), whereas hers also includes a fully-fledged regular expression engine.
\end{diff}
