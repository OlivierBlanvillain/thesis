...
We needed to write an implementation that conforms to our type-level program, and we did!
By duplicating that program, and using an unsafe case to convince the compiler of our good intentions.
...
In principle, Scala~3's type inference should be able to solve half of the problem with its ability to correlate match types and match expression.
