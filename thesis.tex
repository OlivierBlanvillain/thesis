...
More precisely, implicit resolution will iterates thought the list by repeatedly using |casetail|, until it reaches |Remove[V, HNil, Out]|, the last goal of the search, which is unsatisfied.

As an example of usage, consider the following "stringly-typed", JavaScript-inspired API:
