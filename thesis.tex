...
Concretely, we define the low priority implicit in a trait, the high priority implicits in |RemoveAll|'s companion object, and have the object extend that trait:
